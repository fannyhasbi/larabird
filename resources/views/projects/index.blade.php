    ...
    <div class="flex">
      <div class="flex-1 mr-4">
        <div class="mb-4">
          ...
          <input type="text" id="title" class="border border-muted-light py-1 px-2 text-xs block w-full rounded">
        </div>

        <div class="mb-4">
          <label for="description" class="text-sm block mb-2">Description</label>
          <textarea id="description" class="border border-muted-light py-1 px-2 text-xs block w-full rounded" rows="7"></textarea>
        </div>
      </div>
